...
from helper_complex import plot, plot_combined
...
class Agent:
    ...
    def get_action(self, state):
        ...
        self.epsilon = 80 - self.n_games  # number was 80 originally
        final_move = [0, 0, 0]
...
def train():
    ...
    while num_training_games > 0:
        ...
        if done:
            ...
            print('Game', agent.n_games, 'Score', score, 'Record:', record, 'Time: ', time, 'Speed', avg_speed)
