...
def train():
    ...
    filename_num = num_training_games
    while num_training_games > 0:
        # get old state
        ...
        if done:
            ...
            if num_training_games == 1:
                ...
                plot(plot_scores, plot_mean_scores,title="Traditional Snake Traning: Score vs Number of games",filepath="simple_snake/figures/",filename=str(filename_num)+"_games_basic_" + str(round(mean_score,2)) + "_mean")
            else:
                plot(plot_scores, plot_mean_scores,title="Traditional Snake Traning: Score vs Number of games",filepath="simple_snake/figures/",filename=str(filename_num)+"_games_basic_" + str(round(mean_score,2)) + "_mean", save=False)
